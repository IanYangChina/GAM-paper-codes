...
from manipulation_project.graspnet_agent.graspnet.backbone import Pointnet2Backbone
from manipulation_project.graspnet_agent.graspnet.modules import ApproachNet, CloudCrop, OperationNet, ToleranceNet
from manipulation_project.graspnet_agent.graspnet.loss import get_loss
from manipulation_project.graspnet_agent.utils.loss_utils import GRASP_MAX_WIDTH, GRASP_MAX_TOLERANCE
from manipulation_project.graspnet_agent.utils.label_generation import process_grasp_labels, match_grasp_view_and_label, batch_viewpoint_params_to_matrix
...
def pred_decode(end_points):
    ...
    for i in range(batch_size):
        ...
        grasp_point_idx = torch.arange(1024, device='cuda:0').view(1024, 1)
        ...
        grasp_point_idx = grasp_point_idx[objectness_mask]
        ...
        grasp_preds.append(torch.cat([grasp_score, grasp_width, grasp_height, grasp_depth, rotation_matrix, grasp_center, obj_ids, grasp_point_idx], axis=-1))
    return grasp_preds
